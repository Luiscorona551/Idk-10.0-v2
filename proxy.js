...
(async () => {
  if (document.readyState === 'loading') await new Promise(resolve => document.addEventListener('DOMContentLoaded', resolve, { once: true }));
   const files = ['/idk-batch-fourteen.css', '/idk-game-fix.js', '/idk-batch-fourteen.js', '/idk-batch-sixteen.js', '/idk-release-batch.css', '/idk-release-next.js', '/idk-redesign.css', '/idk-redesign.js', '/idk-all-six.css', '/idk-all-six.js', '/idk-rooms.css', '/idk-rooms.js', '/idk-calls-friendly.css', '/idk-calls-friendly.js', '/idk-nonchat-suite.css', '/idk-nonchat-suite.js', '/idk-os-expansion.css', '/idk-os-expansion.js'];
