(() => {
  'use strict';
  const STORAGE_KEYS = ['theme', 'idkCustomTheme', 'wallpaper', 'iconSize', 'dockPosition', 'motion', 'idkDesktopWidgets', 'idkWidgetConfig', 'idkFileSystem', 'idkDropzone', 'idkInstalledPrograms', 'idkProgramSafety', 'idkProgramVersions', 'idkPendingAppUpdates', 'idkEchoAutomations', 'idkMailMessages', 'idkMessengerProfile', 'idkTodos', 'idkCalendarEvents', 'idkRichNotes', 'idkAudioSettings', 'idkAccessibility', 'idkSmartWorkspaces', 'idkClipboardHistory', 'idkSystemTimeline'];
