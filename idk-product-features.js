(() => {
  ...
  function appCenter() {
    ...
    root.querySelector('[data-actions]').append(button('Install HTML program', () => window.IDKInstaller?.open?.(), 'btn'), button('File associations', fileAssociations, 'btn tab'), button('Refresh programs', () => appCenter(), 'btn tab'));
