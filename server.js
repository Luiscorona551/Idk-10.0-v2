...
const PRIVATE = /^\/(node_modules|public|package(-lock)?\.json|server\.js|chat\.js|ai\.js|setup-gate\.js|idk-account-server\.js|Dockerfile|render\.yaml|\.env)/;
...
initAccountDb().then(() => server.listen(port, host, () => {
