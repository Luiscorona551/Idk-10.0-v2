...
const ASSETS = [
  ...
  '/proxy.js', '/apps.js', '/os.js', '/system-apps.js', '/idk-account-client.js', '/idk-v2-features.js', '/idk-batch-eleven.js', '/idk-local-agent.js', '/idk-batch-thirteen.js', '/idk-batch-fourteen.js', '/idk-batch-fifteen.js', '/idk-batch-sixteen.js', '/idk-batch-seventeen.js', '/idk-batch-eighteen.js', '/idk-batch-nineteen.js', '/idk-batch-twentyone.js', '/idk-roadmap-suite.js', '/idk-redesign.css', '/idk-redesign.js', '/idk-all-six.css', '/idk-all-six.js', '/idk-rooms.css', '/idk-rooms.js', '/idk-calls-friendly.css', '/idk-calls-friendly.js'
];
