const CACHE = 'idk-shell-v22';
const ASSETS = [
  '/', '/desktop.html', '/style.css', '/idk-pwa-manifest.json', '/idk-batch-fourteen.css', '/idk-batch-fifteen.css', '/idk-batch-sixteen.css', '/idk-batch-seventeen.css', '/idk-batch-eighteen.css', '/idk-batch-nineteen.css',
  ...
  '/proxy.js', '/apps.js', '/os.js', '/system-apps.js', '/idk-account-client.js', '/idk-v2-features.js', '/idk-batch-eleven.js', '/idk-local-agent.js', '/idk-batch-thirteen.js', '/idk-batch-fourteen.js', '/idk-batch-fifteen.js', '/idk-batch-sixteen.js', '/idk-batch-seventeen.js', '/idk-batch-eighteen.js', '/idk-batch-nineteen.js'
];
