const CACHE = 'idk-shell-v12';
const ASSETS = [
  '/', '/desktop.html', '/style.css', '/idk-pwa-manifest.json',
  '/idk-os-next.css', '/idk-platform-next.css', '/idk-platform-polish.css', '/idk-batch-eight.css', '/idk-batch-nine.css', '/idk-batch-ten.css', '/idk-batch-eleven.css',
  ...
  '/proxy.js', '/apps.js', '/os.js', '/system-apps.js', '/idk-account-client.js', '/idk-v2-features.js', '/idk-batch-eleven.js'
];
