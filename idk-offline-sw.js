...
const CACHE = 'idk-shell-v30';
const ASSETS = [
  '', 'desktop.html', 'game.html', 'style.css', 'idk-pwa-manifest.json', 'idk-batch-fourteen.css', 'idk-batch-fifteen.css', 'idk-batch-sixteen.css', 'idk-batch-seventeen.css', 'idk-batch-eighteen.css', 'idk-batch-nineteen.css', 'idk-batch-twentyone.css', 'idk-roadmap-suite.css', 'idk-os-expansion.css',
  ...
  'proxy.js', 'apps.js', 'os.js', 'system-apps.js', 'idk-account-client.js', 'idk-v2-features.js', 'idk-batch-eleven.js', 'idk-local-agent.js', 'idk-batch-thirteen.js', 'idk-batch-fourteen.js', 'idk-batch-fifteen.js', 'idk-batch-sixteen.js', 'idk-batch-seventeen.js', 'idk-batch-eighteen.js', 'idk-batch-nineteen.js', 'idk-batch-twentyone.js', 'idk-roadmap-suite.js', 'idk-redesign.css', 'idk-redesign.js', 'idk-all-six.css', 'idk-all-six.js', 'idk-rooms.css', 'idk-rooms.js', 'idk-calls-friendly.css', 'idk-calls-friendly.js', 'idk-final-features.js', 'idk-game-fix.js', 'idk-nonchat-suite.css', 'idk-nonchat-suite.js', 'idk-os-expansion.css', 'idk-os-expansion.js'
].map(asset);
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      if (event.request.mode === 'navigate') return caches.match(asset('desktop.html'));
